 ...
 * secure context with a real, persistent localStorage for the saved career.
 */
public class MainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    web.setBackgroundColor(0xFF0B1016);
  ...
  public void onBackPressed() {
    // Let the page close a sheet or step back a screen first. It refuses to
    // handle back only when there is genuinely nowhere left to go.
