#!/usr/bin/env bash
# Serves game/ , opens it in headless Chromium, and plays many careers through
# the real screen with ui-sim.mjs. CAREERS and MONTHS size the run.
#
...
NO_PROXY='*' no_proxy='*' CDP_PORT="$CDP_PORT" node "$HERE/ui-sim.mjs"
