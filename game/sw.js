...
var ASSETS = [
  ...
  './js/data-events.js', './js/data-dialogue.js', './js/people.js', './js/field.js', './js/elections.js',
  './js/engine.js', './js/governance.js', './js/dialogue.js', './js/ui.js', './js/main.js'
];
