...
(function () {
  ...
  C.MZ = {
    ...
    terms: T({ meeting: 'comício', meetingPl: 'comícios', primary: 'colocação na lista',
      conference: 'congresso do partido', exec: 'Comissão Política', execShort: 'CP',
      assembly: 'Assembleia da República', mp: 'Deputado', mpShort: 'Deputado',
      hos: 'Presidente', hosFull: 'Presidente da República',
      deputyHos: 'Primeiro-Ministro', minister: 'Ministro', deputyMin: 'Vice-Ministro',
      cabinet: 'Conselho de Ministros', constituency: 'círculo', ward: 'bairro', branch: 'célula',
      council: 'município', councillor: 'vereador', sg: 'Secretário-Geral',
      leaderTitle: 'Presidente do Partido', deputyTitle: 'Vice-Presidente do Partido',
      region: 'província', regionPl: 'províncias', chief: 'régulo',
      youthWing: 'Organização da Juventude', elder: 'mais-velho' }),
  ...
  C.AO = {
    ...
    terms: T({ meeting: 'comício', meetingPl: 'comícios', primary: 'colocação na lista',
      conference: 'congresso do partido', exec: 'Bureau Político', execShort: 'Bureau',
      assembly: 'Assembleia Nacional', mp: 'Deputado', mpShort: 'Deputado',
      hos: 'Presidente', hosFull: 'Presidente da República',
      deputyHos: 'Vice-Presidente', minister: 'Ministro', deputyMin: 'Secretário de Estado',
      cabinet: 'Conselho de Ministros', constituency: 'círculo', ward: 'bairro', branch: 'célula',
      council: 'município', councillor: 'vereador', sg: 'Secretário-Geral',
      leaderTitle: 'Presidente do Partido', deputyTitle: 'Vice-Presidente do Partido',
      region: 'província', regionPl: 'províncias', chief: 'soba',
      youthWing: 'JMPLA', elder: 'mais-velho' }),
